...
const PRESERVED: RoutesType = import.meta.glob("/src/pages/404.tsx", {
  eager: true,
});
...
export const routes = Object.keys(ROUTES).map((route) => {
  ...
  return {
    ...
    component: React.lazy(
      ROUTES[route] as () => Promise<{ default: React.ComponentType }>
    ),
    preload: ROUTES[route],
  };
});

const preserved: PreservedRoutesType = Object.keys(PRESERVED).reduce(
  (preserved, file) => {
